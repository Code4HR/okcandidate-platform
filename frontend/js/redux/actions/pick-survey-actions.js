...
export function fetchNonRegionLimitedSurveys() {
    return (dispatch) => {
        ...
        return fetch(getIsoUrl('/api/v1/survey?regionLimit=false'))
            .then(checkStatus)
            .then(response => response.json())
            .then(response => {
...
export function fetchSurveysByLocation(coordinates) {
    return function(dispatch) {
        ...
        return fetch(getIsoUrl(`/api/v1/survey/location?coordinates=${JSON.stringify(coordinates)}`))
            .then(checkStatus)
            .then(response => response.json())
            .then(response => {
...
export function getLocationByAddress(address) {
    return function(dispatch) {
        ...
        fetch(getIsoUrl(`/api/v1/geolocation?address=${address}`))
            .then(checkStatus)
            .then((response) => response.json())
            .then((response) => {
